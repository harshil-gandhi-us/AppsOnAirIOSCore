...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AppsOnAirIOSCore.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/harshil-gandhi-16/AppsOnAirIOSCore'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'harshil-gandhi-16' => 'harshil.gandhi@logicwind.com' }
  s.source           = { :git => 'https://github.com/harshil-gandhi-16/AppsOnAirIOSCore.git',  :branch => 'main' }
